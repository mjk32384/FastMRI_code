...
def parse():
    ...
    parser.add_argument('-n', '--net-name', type=Path, default='test_6125_shuffled', help='Name of network')
    ...
    parser.add_argument('--chans', type=int, default=13, help='Number of channels for cascade U-Net | 18 in original varnet') ## important hyperparameter
    parser.add_argument('--sens_chans', type=int, default=6, help='Number of channels for sensitivity map U-Net | 8 in original varnet') ## important hyperparameter
