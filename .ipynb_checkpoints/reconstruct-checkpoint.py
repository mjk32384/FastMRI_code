...
def parse():
    ...
    parser.add_argument('-n', '--net_name', type=Path, default='test_894_varnet_2', help='Name of network')
    parser.add_argument('-p', '--path_data', type=Path, default='../../home/Data/leaderboard/', help='Directory of test data')
    
    parser.add_argument('--cascade', type=int, default=8, help='Number of cascades | Should be less than 12')
